	                            ...
	                            <table style="background-color: #f2f3f8; max-width:670px;  margin:0 auto;" width="100%" border="0"
	                                ...
	                                <tr>
	                                    <td style="text-align:center;">
	                                      	<a href="http://localhost/2remote.com" title="logo" target="_blank">
	                                        	<h1>Car Hiring Reference Bureau</h1>
	                                      	</a>
	                                    </td>
	                                </tr>
	                                <tr>
	                                            ...
	                                            <tr>
	                                                <td style="padding:0 35px;">
	                                                    ...
	                                                    <div style="color:#455056; font-size:15px;line-height:24px; margin:0;">
	                                                        ...
	                                                        <a href="http://localhost/2remote.com/activation?userid='.$parent_id.'&email='.$email.'&pass='.$password.'" class="linkBtn"> Activate Account</a>
	                                                        <p> You can also copy and paste the link below into your browser.</p>
	                                                        <p>http://localhost/2remote.com/activation?userid='.$parent_id.'&email='.$email.'&pass='.$password.'</p>
